...
def generate_queries():
    ...
    if downloaded_file:
        csv_file_path = os.path.join('generate_queries_ans/result', downloaded_file)
        ...
        if insert_queries:
            save_queries_to_file([create_table_query] + insert_queries, 'generate_queries_ans/result/queries.sql')
